...
class ScheduleVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        for i in 0..<70{
            ...
            classlabel.font = UIFont.systemFontOfSize(CGFloat(10))
            classlabel.lineBreakMode = NSLineBreakMode.ByWordWrapping
            classlabel.numberOfLines = 0;
            classlabel.frame = CGRect(x: subViewX-2, y: subViewY-6, width: subViewW+8, height: subViewH/2+3)
